...
| ----------------------------------------------------- | ----------------------------- | ------------------------------------------------------------- |
| [**Function Code**](/function-app/function_app.py)    | `function_app.py`             | The Azure Function code (provided — should be in your repo)   |
| [**Requirements**](/function-app/requirements.txt)    | `requirements.txt`            | Python dependencies                                           |
| [**Test Function**](/function-app/test-function.http) | `test-function.http`          | REST Client test requests                                     |
| [**Client**](/client/client.html)                     | `client.html`                 | FleetBook web app                                             |
| [**Settings Template**](/local.settings.example.json) | `local.settings.example.json` | Settings template with placeholder values (NOT the real keys) |
| [**README**](/README.md)                              | `README.md`                   | Brief setup instructions for your project                     |
| [**Demo Video Link**](https://youtu.be/hynn4JOudZI)   | **Demo Video Link**           | YouTube link (in your README or submitted separately)         |
